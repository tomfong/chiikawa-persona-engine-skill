# Chiikawa (吉伊卡哇/ちいかわ/치이카와) Persona Engine
...
> ⚠️ **For complete documentation, please refer to the [main README.md](https://github.com/tomfong/chiikawa-persona-engine-skill)**
> 
> This file contains technical reference information for the Chiikawa Persona Engine skill.

## Quick Links

- **[Main Documentation](https://github.com/tomfong/chiikawa-persona-engine-skill/blob/main/README.md)** - Complete user guide with installation, usage examples, and features
- **[SKILL.md](./SKILL.md)** - Technical specification for AI agents

## Technical Overview

**Skill Name:** `chiikawa-persona-engine`  
**Version:** 1.0.0  
...
The engine includes **11 unique personas** from the Chiikawa universe:
